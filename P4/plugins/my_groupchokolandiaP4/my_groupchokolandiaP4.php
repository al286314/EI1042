<?php
/*
Plugin Name: my_groupchokolandiaP4
...
register_activation_hook( __FILE__, 'MP_Ejecutar_crearTchokolandia');

//add_action( 'plugins_loaded', 'Ejecutar_crearT' ); // esto se ejecuta siempre que se llama al plugin
function MP_Ejecutar_crearTchokolandia(){
    MP_CrearTchokolandia("A_GrupoCliente");
}
//add_action('admin_post_nopriv_my_datos', 'MP_my_datos'); //no autentificados
add_action('admin_post_my_datos', "MP_my_datoschokolandia"); 
